      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
                ...
                >
                  <button
                    ...
                    className={`px-3 py-2 rounded-md text-xs font-bold uppercase tracking-wider flex items-center gap-1 transition-colors cursor-pointer select-none ${
                      isOpen
                        ? 'text-[#0B3D91] bg-blue-50/90 border-b-2 border-[#F5A623]'
        ...
        {activeCategory && (
          ...
          >
            ...
            <div className="col-span-4 bg-slate-50 border border-slate-200 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden group">
              <div className="absolute -right-8 -bottom-8 w-32 h-32 bg-amber-500/10 rounded-full blur-xl group-hover:scale-150 transition-transform pointer-events-none"></div>
