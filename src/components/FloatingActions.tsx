  ...
  return (
    <div id="floating-action-controls" className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
      ...
      <a
        ...
        className="pointer-events-auto flex items-center gap-2 px-4 py-2.5 rounded-full bg-orange-600 hover:bg-orange-500 text-white font-bold text-xs shadow-xl hover:shadow-orange-600/30 transition-all hover:scale-105 group"
      ...
      >
        ...
        <span className="w-2 h-2 rounded-full bg-orange-200 animate-pulse"></span>
      </a>
    </div>
  );
};
