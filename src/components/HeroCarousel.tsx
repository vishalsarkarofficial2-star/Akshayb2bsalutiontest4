            ...
            >
              ...
              <div className="relative h-56 sm:h-64 overflow-hidden bg-slate-900">
                ...
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-1 rounded-full bg-orange-600/90 text-white text-[11px] font-bold shadow-md flex items-center gap-1">
              ...
              <div className="p-5 text-slate-900 bg-white space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  ...
                  <div className="p-2 rounded-xl bg-orange-50 border border-orange-100">
                    ...
                    <span className="text-xs font-extrabold text-orange-800 block truncate">{slide.stat3}</span>
                  </div>
                </div>
