          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                <li>
                  <button onClick={() => onSelectService('Basic Registration Firm')} className="hover:text-white transition-colors cursor-pointer">
                    Basic Registration Firm
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button onClick={() => onSelectService('Central License')} className="hover:text-white transition-colors cursor-pointer">
                    Central License
                  </button>
                </li>
                <li>
