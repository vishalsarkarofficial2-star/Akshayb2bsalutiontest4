      ...
      <main className="flex-grow">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <a href={CSR1_REFERENCE_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs font-bold text-amber-300 hover:text-white underline underline-offset-4">
        ...
        <section id="registration" className="py-14 bg-slate-50 border-b border-slate-200 scroll-mt-20">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-2"><h4 className="text-xs font-bold uppercase tracking-wider text-[#0B3D91] flex items-center gap-1.5"><FileCheck className="w-4 h-4 text-[#F5A623]"/><span>How Our Compliance Desk Helps:</span></h4><p className="text-xs text-slate-600 leading-relaxed">We review eligibility, verify supporting registrations, prepare the CSR-1 form, coordinate professional certification and assist with online MCA submission and status tracking.</p></div>
          </div>
        </section>
