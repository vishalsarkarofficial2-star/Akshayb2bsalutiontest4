          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                <li>
                  <button onClick={() => onSelectService('Sole Proprietorship Society')} className="hover:text-white transition-colors cursor-pointer">
                    Sole Proprietorship Society
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button onClick={() => onSelectService('Limited Liability Society')} className="hover:text-white transition-colors cursor-pointer">
