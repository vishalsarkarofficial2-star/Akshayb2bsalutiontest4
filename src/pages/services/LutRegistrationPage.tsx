          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="overflow-x-auto bg-white rounded-2xl border border-slate-200 shadow-sm">
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead><tr className="bg-[#0B3D91] text-white"><th className="p-3.5">Parameter</th><th className="p-3.5 bg-amber-500 text-[#0B3D91]">Export under LUT</th><th className="p-3.5">Export with IGST Payment</th></tr></thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  ...
                  ].map((row, idx) => <tr key={idx} className="hover:bg-slate-50">{row.map((cell, i) => <td key={i} className={`p-3.5 ${i===0?'font-bold text-slate-900':''} ${i===1?'bg-amber-50/60 font-semibold':''}`}>{cell}</td>)}</tr>)}
                </tbody>
              </table>
            </div>
          </div>
