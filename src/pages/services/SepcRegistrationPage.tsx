            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <BriefcaseBusiness className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                    <span>Service Exporter Focused</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Laptop2 className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <PlaneTakeoff className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                ...
                <li>
                  <button onClick={() => onSelectService('Limited Liability SEPC')} className="hover:text-white transition-colors cursor-pointer">
