              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold bg-amber-500 text-[#0B3D91] border-r border-amber-600">Voluntary Resignation</th>
                    <th className="p-3.5 font-bold">Company-Initiated Removal</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr><td className="p-3.5 font-bold border-r">Primary Route</td><td className="p-3.5 bg-amber-50/60 border-r">Section 168</td><td className="p-3.5">Section 169, where applicable</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">Who Initiates</td><td className="p-3.5 bg-amber-50/60 border-r">Director</td><td className="p-3.5">Company members / shareholders</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">Key Starting Document</td><td className="p-3.5 bg-amber-50/60 border-r">Written resignation notice</td><td className="p-3.5">Special notice / proposed resolution</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">Meeting Requirement</td><td className="p-3.5 bg-amber-50/60 border-r">Board records the resignation</td><td className="p-3.5">Members\' meeting process is generally required</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">Opportunity to be Heard</td><td className="p-3.5 bg-amber-50/60 border-r">Not normally relevant</td><td className="p-3.5">Director is entitled to a reasonable opportunity of being heard</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">MCA Update</td><td className="p-3.5 bg-amber-50/60 border-r">DIR-12 filing by company</td><td className="p-3.5">DIR-12 filing after valid corporate action</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">Best For</td><td className="p-3.5 bg-amber-50/60 border-r">Director leaving voluntarily</td><td className="p-3.5">Eligible cases where company seeks removal before term expiry</td></tr>
                  <tr><td className="p-3.5 font-bold border-r">Professional Support</td><td className="p-3.5 bg-amber-50/60 border-r">Documentation + filing</td><td className="p-3.5">Notice, resolutions, meeting records + filing</td></tr>
                </tbody>
              </table>
            </div>
          </div>
