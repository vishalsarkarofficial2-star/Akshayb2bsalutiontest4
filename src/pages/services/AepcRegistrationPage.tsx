            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Shirt className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                    <span>Garment Exporter Focused</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <PackageCheck className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Globe2 className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
                    <span>DGFT / AEPC Filing</span>
                  </div>
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <Ship className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                <li>
                  <button onClick={() => onSelectService('Sole IEC Firm')} className="hover:text-white transition-colors cursor-pointer">
                    Sole IEC Firm
                  </button>
                </li>
                <li>
                ...
                <li>
                  <button onClick={() => onSelectService('GST / Other Export Compliance')} className="hover:text-white transition-colors cursor-pointer">
                    GST / Other Export Compliance
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Limited Liability AEPC')} className="hover:text-white transition-colors cursor-pointer">
                    Limited Liability AEPC
                  </button>
                </li>
                <li>
