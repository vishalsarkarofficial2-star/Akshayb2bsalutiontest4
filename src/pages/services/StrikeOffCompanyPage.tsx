              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold bg-amber-500 text-[#0B3D91] border-r border-amber-600">Voluntary Strike Off</th>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-slate-50">
                      {row.map((cell, cidx) => (
                        <td key={cidx} className={`p-3.5 ${cidx === 0 ? 'font-bold text-slate-900' : ''} ${cidx === 1 ? 'bg-amber-50/60 font-semibold text-orange-800' : ''} ${cidx < row.length - 1 ? 'border-r border-slate-200' : ''}`}>
                          {cell}
                        </td>
                      ))}
                    </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                ...
                <li>
                  <button onClick={() => onSelectService('LLP Closure')} className="hover:text-white transition-colors cursor-pointer">
                    LLP Closure
                  </button>
                </li>
                <li>
