              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#0B3D91] text-white">
                    ...
                    <th className="p-3.5 font-bold bg-amber-500 text-[#0B3D91] border-r border-amber-600">Modification Support</th>
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-slate-50">
                      ...
                      <td className="p-3.5 bg-amber-50/60 font-semibold text-orange-800 border-r border-slate-200">{row[1]}</td>
