            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-1">
                  ...
                  <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/10 border border-white/20 text-xs font-semibold text-white">
                    <BarChart3 className="w-4 h-4 text-[#F5A623] flex-shrink-0" />
              ...
              <table className="w-full text-left text-xs border-collapse min-w-[700px]">
                ...
                <tbody className="divide-y divide-slate-200 text-slate-700">
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold text-orange-800 border-r border-slate-200">Report tax deducted at source</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold border-r border-slate-200">Periodic / quarterly statements</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold border-r border-slate-200">TAN + PAN</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold border-r border-slate-200">Payments, deductions, challans & deductee PANs</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold border-r border-slate-200">PAN/challan mismatch or late filing</td>
                  ...
                  <tr className="hover:bg-slate-50">
                    ...
                    <td className="p-3.5 bg-amber-50/60 font-semibold text-slate-900 border-r border-slate-200">Deductors making TDS-applicable payments</td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-400">
                ...
                <li>
                  <button onClick={() => onSelectService('TAN Registration')} className="hover:text-white transition-colors cursor-pointer">
                    TAN Registration
                  </button>
                </li>
                <li>
