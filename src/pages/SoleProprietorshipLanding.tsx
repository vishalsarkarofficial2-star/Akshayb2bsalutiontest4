    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-amber-500 selection:text-white flex flex-col antialiased">
      ...
      <main className="flex-grow">
        ...
        <div className="bg-slate-50 border-b border-slate-200 py-3 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto text-xs text-slate-500 flex items-center gap-2 flex-wrap font-semibold">
            <button 
            ...
            <span className="text-slate-900 font-black">Sole Proprietorship Firm</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                <li>
                  <button onClick={() => scrollToSection('hero-section')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Sole Proprietorship Firm
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Private Limited Company')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Private Limited Company
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Limited Liability Partnership')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Limited Liability Partnership
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('One Person Company')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    One Person Company
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Partnership Firm')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Partnership Firm
                  </button>
                </li>
              </ul>
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                <li>
                  <button onClick={() => onSelectService('GST Registration')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    GST Registration &amp; Filings
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Income Tax Return Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Income Tax Return (ITR)
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('TDS Return Filing')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    TDS Return Filing
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('MSME Udyam Registration')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    MSME Udyam Certificate
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Accounting & Bookkeeping')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
            ...
            <div className="space-y-2.5">
              ...
              <ul className="space-y-1.5 text-slate-600">
                <li>
                  <button onClick={() => onSelectService('Trademark Registration')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Trademark (™) Registration
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('FSSAI Registration')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    FSSAI Food License
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('IEC Registration')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    Import Export Code (IEC)
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('ISO 9001:2015')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
                    ISO 9001 Certification
                  </button>
                </li>
                <li>
                  <button onClick={() => onSelectService('Shop & Establishment')} className="hover:text-[#0B3D91] transition-colors cursor-pointer text-left">
